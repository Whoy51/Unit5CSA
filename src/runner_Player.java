...
public class runner_Player {
    public static void main(String[] args) {
        ...
        while(!instruction.equals("q")) {
            System.out.println("Type the name of the method you want to test. Type q to quit.");
            ...
            if (instruction.equals("getNumPlayers")) {
                ...
                if (choice == 1) {
                    ...
                    if (p1.getX() == p2.getX() && p1.getY() == p2.getY() && p1.getZ() == p2.getZ()) {
                        System.out.println(p1.getName() + " and " + p2.getName() + " are at the same location");
                    } else {
                        System.out.println(p1.getName() + " and " + p2.getName() + " are in different locations");
                    }
                } else {
                    System.out.println("Invalid choice");
                }
